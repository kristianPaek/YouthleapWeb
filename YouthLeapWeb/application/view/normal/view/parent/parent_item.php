						  ...
						  <div class="tab-content">
							  ...
							  <div class="tab-pane active" id="tab_1_1">
								  <form role="form" action="api/student/save" id="form_common" class="horizontal-form" method="post">
										...
										<?php $mParent->hidden("user_id"); ?>
										<?php $mParent->hidden("user_image"); ?>
										<?php $mParent->hidden("user_thumb"); ?>
										<?php $mParent->hidden("role_id"); ?>
										<?php $mParent->hidden("is_active"); ?>
							  ...
							  <div class="tab-pane" id="tab_1_2">
								  ...
								  <form action="api/student/save_avatar" role="form" method="post" id="form_avatar">
										<input type="hidden" id="avatar_id" name="avatar_id" value="<?php p($mParent->id);?>" />
									  <div class="form-group">
							  ...
							  <div class="tab-pane" id="tab_1_3">
								  <form action="api/student/save_password" role="form" method="post" id="form_password">
										<input type="hidden" id="password_id" value="<?php p($mParent->user_id);?>" />
									  <div class="form-group">
										  <label for="new_password">New Password</label>
										  <?php $mParent->password("new_password", array("maxlength" => 30)); ?>
										</div>
									  <div class="form-group">
										  <label for="confirm_new_password">Re-type New Password</label>
										  <?php $mParent->password("confirm_new_password", array("maxlength" => 30)); ?>
										</div>
									  <div class="margin-top-10">
